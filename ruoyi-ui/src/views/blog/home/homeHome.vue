<template>
    <div class="mainmain">
        <el-card class="mainPage">
            <div class="zyyo-filter"></div>

            <div class="zyyo-main">
                <div class="zyyo-left">
                    <div class="logo" style="background-image: url('../../../assets/shouye/img/logo.png');">
                        <img style="position: absolute;top:-15%;left:-10%;width: 120%; aspect-ratio: 1/1;"
                            src="../../../assets/shouye/img/logokuang.png">
                    </div>
                    <div class="left-div left-des">
                        ...
                        <div class="left-des-item"><svg t="1705773906032" class="icon" viewbox="0 0 1024 1024"
                                version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2474">
                                <path
                ...
                <div class="zyyo-right">
                    <header>
                        <div class="index-logo" style="background-image: url(../../../assets/shouye/img/logo.png);">
                            <img style="position: absolute;top:-15%;left:-10%;width: 120%; aspect-ratio: 1/1;"
                                src="../../../assets/shouye/img/logokuang.png">
                        </div>
                        <div class="welcome">
                        ...
                        <div class="description">
                            👦 <span class="purpleText">Full Stack</span> Developer
                        </div>
                        <div class="description">
                        ...
                        <div class="iconContainer">
                            ...
                            </a><a class="iconItem" onclick="pop('../../../assets/shouye/img/wxzsm.jpg')"
                                href="javascript:void(0)">
                                <svg t="1705247464964" class="icon" viewbox="0 0 1024 1024" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" p-id="4987">
                                    <path
                            ...
                            </a><a class="iconItem" onclick="pop('../../../assets/shouye/img/qq.jpg')"
                                href="javascript:void(0)">
                                <svg t="1712319361023" class="icon" viewbox="0 0 1024 1024" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" p-id="1861">
                                    <path
                        ...
                        <div class="tanChiShe">
                            <img id="tanChiShe" src="../../../assets/shouye/svg/snake-Light.svg" alt="">
                        </div>
                    </header>
                    ...
                    <content>
                        ...
                        <div class="projectList">
                            <a class="projectItem a" target="_blank" href="">
                                ...
                                <div class="projectItemRight">
                                    <img src="../../../assets/shouye/img/i1.png" alt="">
                                </div>
                                ...
                                <div class="projectItemRight">
                                    <img src="../../../assets/shouye/img/i2.png" alt="">
                                </div>
                            ...
                            <a class="projectItem a" target="_blank" href="">
                                ...
                                <div class="projectItemRight">
                                    <img src="../../../assets/shouye/img/i4.png" alt="">
                                </div>
                        ...
                        <div class="skill">
                            <img id="skillPc" src="../../../assets/shouye/svg/skillPc.svg" alt="" srcset="">
                            <img id="skillWap" src="../../../assets/shouye/svg/skillWap.svg" alt="" srcset="">
                        </div>
                    </content>
                </div>
            </div>
...
<script src="../../../assets/shouye/js/script.js"></script>
<script>
    export default {
      name: 'HomePage',
      // Vue 组件的逻辑
...
@font-face {
    ...
    src: url(../../../assets/shouye/fonts/Ubuntu-Regular.ttf);
    font-display: swap;
}
...
@font-face {
    font-family: "title";
    /*英文字体*/
    src: url(../../../assets/shouye/fonts/Pacifico-Regular.ttf);
    font-display: swap;
}
...
.mainmain {
    --name: 主题1;
    /* --main_bg_color: url(../../../assets/shouye/img/background.jpg); */
