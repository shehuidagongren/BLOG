  ...
  export default {
    ...
    created() {
      ...
      if (this.articleId) {
        ...
        this.queryParams.articleType = 2;
        this.getList();
      } else {
    ...
    methods: {
      fetchArticleData(articleId) {
        // 使用getFavorites API函数获取文章数据
        getFavorites(articleId).then(response => {
