      ...
      <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
        <el-row>
          <el-form-item label="名称" prop="goalName">
            <el-input v-model="queryParams.goalName" placeholder="请输入知识点名称" clearable
      ...
      <el-card v-for="(goal, index) in goalList" :key="index"
        ...
        <el-row>
          ...
          <el-col :span="18">
            ...
            <el-row>
              <el-col :span="12">
                记录时间：<span>{{ goal.comeTrueData }}</span>
              </el-col>
                <el-col :span="6">
                  <a :href="goal.articleId" target="_blank"><el-tag >博客直达 -></el-tag></a>
                </el-col>
            </el-row>
            <el-row>
            </el-row>
